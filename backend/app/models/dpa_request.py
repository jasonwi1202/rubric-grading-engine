"""DpaRequest ORM model.

Stores inbound DPA (Data Processing Agreement) requests submitted from
the /legal/dpa page by school/district administrators.  No student PII
...
class DpaRequest(Base):
    """A DPA request submitted from the /legal/dpa page."""

    __tablename__ = "dpa_requests"

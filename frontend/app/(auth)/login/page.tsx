...
/**
 * Inner form component that reads useSearchParams.
 * Must be rendered inside a <Suspense> boundary (required by Next.js 15 when
 * useSearchParams is called in a component that may be statically rendered).
 */
function LoginForm() {
